...
def parse_args(args_):
    ...
    parser.add_argument(
        "--model",
        default="models/stats_box_1024.pkl",
        help="the path to the pickled model, for evaluation",
    )
    parser.add_argument(
        "--query",
        default="query.sql",
    ...
    parser.add_argument(
        "--grid",
        help="grid size of model training",
        type=int,
        choices=range(5, 2**20),
        default=2**10,
    )
    parser.add_argument(
        "--method",
    ...
    parser.add_argument(
        "--cdf",
        help="use cumulative density function (cdf) instead of pdf, to boost query processing",
        action="store_true",
        default=False,
    )
