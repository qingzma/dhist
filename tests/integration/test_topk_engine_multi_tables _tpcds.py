...
class TestTopkEngineMethod(unittest.TestCase):
    def __init__(self, methodName: str = "runTest") -> None:
        ...
        self.model_name = "model_tpcds1g_topk_200_20"
    ...
    # def test_multi_way_no_selection_4_b_c_p_u(self):
    ...
    # def test_2_table_4_selection_1(self):
    ...
    # def test_2_table_4_selection_2(self):
    ...
    #     logger.info("truth %.6E", truth)
    #     logger.info("time cost is %.5f s.", t2 - t1)
    #     self.assertTrue(q_error(res, truth) < 30)
